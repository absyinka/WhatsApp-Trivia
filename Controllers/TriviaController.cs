...
namespace WhatsAppTriviaApp.Controllers;
...
public class TriviaController : TwilioController
{
    ...
    public async Task<IActionResult> Index()
    {
        ...
        var body = form["Body"].ToString().ToString().ToUpper().Trim();
    ...
    private async Task StartGame()
    {
        ...
        var trivia = await _triviaService.GetTrivia();
        var questions = _triviaService.ConvertTriviaToQuestions(trivia);
